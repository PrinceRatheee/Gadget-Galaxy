...
const Brands = () => {
  return (
    <div>
      ...
      <div className="flex w-[80%] container justify-between flex-wrap ">
        <div className="flex items-center ">
          <img
            src="/brands/png-apple-logo-9711.png"
            alt="Product Image"
        ...
        <div className="flex items-center">
            <img src="/brands/jbl-logo-3-1.png"alt="Product Image" className="w-[5rem] cursor-pointer"/>
        </div>
        <div className="flex items-center cursor-pointer">
            <img src="/brands/images.png" alt="Product Image"/>
        </div>
        <div className="flex items-center cursor-pointer">
            <img src="/brands/86762ae15cd05504062a962c6a1d49e4.w2000.h2000.png" alt="Product Image" className="w-[7rem]"/>
        </div>
      </div>
    </div>
  );
